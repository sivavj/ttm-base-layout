...
var React6, import_jsx_runtime3, _excluded4;
...
var React7, import_prop_types6, import_jsx_runtime4, ThemeProvider_default2;
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider({
    ...
    Object.entries(colorSchemes).forEach(([key, scheme]) => {
      ...
      if (key === resolvedDefaultColorScheme) {
        styleSheet[colorSchemeSelector] = css2;
      } else {
        styleSheet[`${colorSchemeSelector === ":root" ? "" : colorSchemeSelector}[${attribute}="${key}"]`] = css2;
      }
    });
    React10.useEffect(() => {
    ...
    return (0, import_jsx_runtime7.jsxs)(ColorSchemeContext.Provider, {
      value: {
        mode,
        setMode,
        lightColorScheme,
  ...
  true ? CssVarsProvider.propTypes = {
    ...
    prefix: import_prop_types7.default.string,
...
var React10, import_prop_types7, import_jsx_runtime6, import_jsx_runtime7, _excluded7, DISABLE_CSS_TRANSITION;
...
var React11, import_prop_types8, import_jsx_runtime8, _excluded8, defaultTheme, defaultCreateStyledComponent, useThemePropsDefault, useUtilityClasses;
 ...
 */
//# sourceMappingURL=chunk-I7YAXAN6.js.map
